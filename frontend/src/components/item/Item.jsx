...
const Item = (props) => {
  ...
  return (
    <div className='item flex flex-col items-center justify-center text-center'>
      <Link to={`/product/${props.id}`}> <img  onClick={window.scrollTo(0,0)}src={props.image} alt={props.name} className="w-full h-auto object-contain mb-4 max-h-48 lg:max-h-full" /></Link>
